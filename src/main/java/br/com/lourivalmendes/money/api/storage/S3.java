package br.com.lourivalmendes.money.api.storage;
...
public class S3 {
	...
	public String salvarTemporariamente(MultipartFile arquivo) {
		...
		try {
			...
			if (logger.isDebugEnabled())
				logger.debug("Arquivo {} enviado com sucesso para o S3 da AWS.", arquivo.getOriginalFilename());
	...
	public void remover(String objeto) {
		...
		DeleteObjectRequest deleteObjectsRequest = new DeleteObjectRequest(property.getS3().getBucket(), objeto);
